...
public class ListaUsuarios {
	...
	public int buscarNombre(String valor) {
		int i;
		for(i=0;i<cantidad;i++) {
			if((lista[i].getNombre()).equalsIgnoreCase(valor)) {break;}
		}
		if(i==cantidad) {return-1;}else {return i;}
	}
	
	public int buscarContraseña(String valor) {
		int i;
		for(i=0;i<cantidad;i++) {
			if((lista[i].getContraseña()).equalsIgnoreCase(valor)) {break;}
		}
		if(i==cantidad) {return-1;}else {return i;}
	}
